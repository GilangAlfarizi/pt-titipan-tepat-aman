								...
								<NavLink
									...
									className={({ isActive }) =>
										`block py-2 px-3 rounded-sm ${
											isActive
												? "text-white bg-brand rounded-sm md:bg-transparent md:text-fg-brand md:p-0"
												: "block py-2 px-3 text-gray-700 rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent"
										}`
									}>
									{label}
								</NavLink>
